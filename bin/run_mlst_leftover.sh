...
genomes_list_part='$HOME/PROJECTS/GaTech/FCGR_classifier/unprocessed_samples_mlst.txt'
# Define the output file for this specific job
output_results_file='$HOME/PROJECTS/GaTech/FCGR_classifier/unprocessed_samples_mlst_results.tsv'
