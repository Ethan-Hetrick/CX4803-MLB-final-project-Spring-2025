...
genomes_list_part='/scicomp/home-pure/rqu4/PROJECTS/GaTech/FCGR_classifier/unprocessed_samples_mlst.txt'
# Define the output file for this specific job
output_results_file='/scicomp/home-pure/rqu4/PROJECTS/GaTech/FCGR_classifier/unprocessed_samples_mlst_results.tsv'
