...
#$ -N mlst_job_ac # Unique name for this job
#$ -pe smp 1
#$ -l h_rt=72:00:00
#$ -l h_vmem=4G
#$ -q all.q
#$ -j y
#$ -o mlst_job_ac.log # Unique log file
...
output_results_file='/scicomp/home-pure/rqu4/PROJECTS/GaTech/FCGR_classifier/mlst_results_ac.tsv'
